...
pub fn main() {
    ...
    let (constant_hash,btc_best_block_hash)= bitcoin_light_client_circuit::propose_longest_chain(
    ...
    zkm_zkvm::io::commit(&constant_hash);
    zkm_zkvm::io::commit(&included_watchertowers);
