...
use crate::todo_funcs::get_guest_constant_value;
...
pub async fn build_genesis_prekickoff_tx(
    ...
    let assert_commit_num = crate::todo_funcs::assert_commmit_num();
    ...
    let init_amount = crate::todo_funcs::prekickoff_replenishment_amount();
    ...
    let fee_amount = crate::todo_funcs::prekickoff_fee_amount(0);
...
pub async fn build_prekickoff_params(
    ...
    let (replenish_fee_inputs, replenish_fee_prev_outs, fee_amount) = if prekickoff_remaining_amount
        >= crate::todo_funcs::min_prekickoff_input_amount()
    {
        // no need to replenish funds
        (vec![], vec![], crate::todo_funcs::prekickoff_fee_amount(0))
    } else {
        let network = get_network();
        let operator_master_key = OperatorMasterKey::new(get_bitvm_key()?);
        ...
        let replenishment_amount = crate::todo_funcs::prekickoff_replenishment_amount();
        ...
        let replenish_fee_prev_outs: Vec<TxOut> = replenish_fee_inputs
            ...
            .collect();
        let fee_amount = crate::todo_funcs::prekickoff_fee_amount(replenish_fee_inputs.len());
...
pub async fn build_graph_params(
    ...
    Ok(Bitvm2GraphParameters {
        ...
        graph_id,
        graph_nonce,
        challenge_amount: crate::todo_funcs::challenge_amount(),
        operator_pubkey,
