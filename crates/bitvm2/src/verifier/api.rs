...
pub mod test {
    ...
    fn test_extract_proof() {
        ...
        use goat::{
            contexts::base::generate_n_of_n_public_key, scripts::generate_burn_script_address,
        };
        ...
        let verifier_0_keypair =
            committee::generate_keypair_from_seed(VERIFIER_0_SECRET.to_string());
        let verifier_1_keypair =
            committee::generate_keypair_from_seed(VERIFIER_1_SECRET.to_string());
